...
import static luna.Configuration.CACHE_DIR;
...
public class signlink implements Runnable {
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "startpriv", descriptor = "(Ljava/net/InetAddress;)V", line = 70)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "run", descriptor = "()V", line = 87)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "findcachedir", descriptor = "()Ljava/lang/String;", line = 152)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "getuid", descriptor = "(Ljava/lang/String;)I", line = 173)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "opensocket", descriptor = "(I)Ljava/net/Socket;", line = 196)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "openurl", descriptor = "(Ljava/lang/String;)Ljava/io/DataInputStream;", line = 203)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "dnslookup", descriptor = "(Ljava/lang/String;)V", line = 210)
    public static final synchronized void dnslookup(String arg0) {
        dns = arg0;
        dnsreq = arg0;
    }

    @OriginalMember(owner = "client!sign/signlink", name = "startthread", descriptor = "(Ljava/lang/Runnable;I)V", line = 215)
    public static final synchronized void startthread(Runnable arg0, int arg1) {
        threadreqpri = arg1;
        threadreq = arg0;
    }

    @OriginalMember(owner = "client!sign/signlink", name = "wavesave", descriptor = "([BI)Z", line = 219)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "wavereplay", descriptor = "()Z", line = 227)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "midisave", descriptor = "([BI)V", line = 233)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "reporterror", descriptor = "(Ljava/lang/String;)V", line = 247)
