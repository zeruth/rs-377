...
public class Model extends Entity {
    ...
    public static int[] field1257 = Draw3D.field1598;

    @OriginalMember(owner = "client!LZYQDKJV", name = "Jb", descriptor = "[I")
    public static int[] field1258 = Draw3D.field1599;
    ...
    public void method365(int arg0) {
        ...
        this.field1216 = (var2 << 16) + (var3 & 65535);
        if (arg0 <= 0) {
            this.field1184 = 50;
        }
        this.field1217 = (var4 << 16) + (var5 & 65535);
    }
    ...
    public final void method376(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        ...
        for (int var10 = 0; var10 < this.field1199; ++var10) {
            ...
            if (this.field1206 != null && (this.field1206[var10] & 1) != 0) {
    ...
    private final void method378(int arg0, int arg1, int arg2, int arg3, int arg4) {
        for (int var6 = 0; var6 < this.field1199; ++var6) {
            ...
            } else if ((this.field1206[var6] & 1) == 0) {
    ...
    public final void method380(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        int var8 = Draw3D.field1594;
        int var9 = Draw3D.field1595;
                    ...
                    if (var19 / var13 > -Draw2D.field1103) {
                        ...
                        if (var21 / var13 < Draw2D.field1103) {
                            ...
                            if (arg8 > 0 && field1252) {
                                ...
                                int var30 = field1253 - Draw3D.field1594;
                                int var31 = field1254 - Draw3D.field1595;
                            ...
                            int var32 = Draw3D.field1594;
                            int var33 = Draw3D.field1595;
                            int var34 = 0;
                            int var35 = 0;
                            if (arg0 != 0) {
            ...
            if (this.field1206 == null || this.field1206[var5] != -1) {
                ...
                if (arg0 && (var33 == -5000 || var34 == -5000 || var35 == -5000)) {
                    ...
                    if ((field1234[var32] - field1234[var31]) * (var33 - var34) - (field1234[var30] - field1234[var31]) * (var35 - var34) > 0) {
                        ...
                        if (var33 >= 0 && var34 >= 0 && var35 >= 0 && var33 <= Draw2D.field1101 && var34 <= Draw2D.field1101 && var35 <= Draw2D.field1101) {
    ...
    private final void method383(int arg0) {
        if (field1232[arg0]) {
            ...
            Draw3D.field1590 = field1231[arg0];
            if (this.field1208 == null) {
                Draw3D.field1593 = 0;
            } else {
                Draw3D.field1593 = this.field1208[arg0];
            }
            int var5;
            if (this.field1206 == null) {
                var5 = 0;
            } else {
                var5 = this.field1206[arg0] & 3;
            }
            if (var5 == 0) {
                Draw3D.method555(field1234[var2], field1234[var3], field1234[var4], field1233[var2], field1233[var3], field1233[var4], this.field1203[arg0], this.field1204[arg0], this.field1205[arg0]);
            } else if (var5 == 1) {
    ...
    private final void method384(int arg0) {
        int var2 = Draw3D.field1594;
        int var3 = Draw3D.field1595;
        int var4 = 0;
        ...
        if ((var26 - var27) * (var31 - var30) - (var28 - var27) * (var29 - var30) > 0) {
            ...
            if (var4 == 3) {
                if (var26 < 0 || var27 < 0 || var28 < 0 || var26 > Draw2D.field1101 || var27 > Draw2D.field1101 || var28 > Draw2D.field1101) {
                ...
                if (this.field1206 == null) {
                    ...
                    var32 = this.field1206[arg0] & 3;
                }
                if (var32 == 0) {
                    Draw3D.method555(var29, var30, var31, var26, var27, var28, field1248[0], field1248[1], field1248[2]);
                } else if (var32 == 1) {
                    ...
                    Draw3D.method559(var29, var30, var31, var26, var27, var28, field1248[0], field1248[1], field1248[2], field1236[var34], field1236[var35], field1236[var36], field1237[var34], field1237[var35], field1237[var36], field1238[var34], field1238[var35], field1238[var36], this.field1209[arg0]);
                } else if (var32 == 3) {
                    ...
                    Draw3D.method559(var29, var30, var31, var26, var27, var28, this.field1203[arg0], this.field1203[arg0], this.field1203[arg0], field1236[var38], field1236[var39], field1236[var40], field1237[var38], field1237[var39], field1237[var40], field1238[var38], field1238[var39], field1238[var40], this.field1209[arg0]);
                }
            }
            if (var4 == 4) {
                if (var26 < 0 || var27 < 0 || var28 < 0 || var26 > Draw2D.field1101 || var27 > Draw2D.field1101 || var28 > Draw2D.field1101 || field1246[3] < 0 || field1246[3] > Draw2D.field1101) {
                    Draw3D.field1590 = true;
                }
                int var41;
                if (this.field1206 == null) {
                    ...
                    var41 = this.field1206[arg0] & 3;
                }
                if (var41 == 0) {
                    Draw3D.method555(var29, var30, var31, var26, var27, var28, field1248[0], field1248[1], field1248[2]);
                    Draw3D.method555(var29, var31, field1247[3], var26, var28, field1246[3], field1248[0], field1248[2], field1248[3]);
                    return;
                }
                if (var41 == 1) {
                ...
                if (var41 == 2) {
                    ...
                    Draw3D.method559(var29, var30, var31, var26, var27, var28, field1248[0], field1248[1], field1248[2], field1236[var44], field1236[var45], field1236[var46], field1237[var44], field1237[var45], field1237[var46], field1238[var44], field1238[var45], field1238[var46], this.field1209[arg0]);
                    Draw3D.method559(var29, var31, field1247[3], var26, var28, field1246[3], field1248[0], field1248[2], field1248[3], field1236[var44], field1236[var45], field1236[var46], field1237[var44], field1237[var45], field1237[var46], field1238[var44], field1238[var45], field1238[var46], this.field1209[arg0]);
                    return;
                }
                if (var41 == 3) {
                    ...
                    Draw3D.method559(var29, var30, var31, var26, var27, var28, this.field1203[arg0], this.field1203[arg0], this.field1203[arg0], field1236[var48], field1236[var49], field1236[var50], field1237[var48], field1237[var49], field1237[var50], field1238[var48], field1238[var49], field1238[var50], this.field1209[arg0]);
                    Draw3D.method559(var29, var31, field1247[3], var26, var28, field1246[3], this.field1203[arg0], this.field1203[arg0], this.field1203[arg0], field1236[var48], field1236[var49], field1236[var50], field1237[var48], field1237[var49], field1237[var50], field1238[var48], field1238[var49], field1238[var50], this.field1209[arg0]);
                }
            }
        }
    }
