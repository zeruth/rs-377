...
import rs2.graphics.PixMap;

import static luna.Configuration.FIX_MOUSE_BUTTONS;
...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    public final void mousePressed(MouseEvent arg0) {
        ...
        boolean shouldFix = FIX_MOUSE_BUTTONS && (arg0.getButton() != 1);
        if (arg0.isMetaDown() || shouldFix) {
            this.field961 = 2;
            this.field958 = 2;
        } else {
            this.field961 = 1;
